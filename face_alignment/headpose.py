...
def draw_pose(img, keypoints):
    ...
    euler_angle = euler_angle.reshape(-1)
    for start, end in line_pairs:
        cv2.line(img, reprojectdst[start], reprojectdst[end], (0, 255, 255), 2)
    cv2.putText(img, f'pitch:{euler_angle[0]:.2f}', (0, 20 + 0 * 20),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0))
    cv2.putText(img, f'roll:{euler_angle[1]:.2f}', (0, 20 + 1 * 20),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0))
    cv2.putText(img, f'yaw:{euler_angle[2]:.2f}', (0, 20 + 2 * 20),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0))
